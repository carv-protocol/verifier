...
func TestVerifyAttesation(t *testing.T) {
	//readfile

	trusted, err := os.ReadFile("../../configs/trusted.json")
	if err != nil {
		t.Errorf("Error reading file: %v", err)

	}
	identity, err := os.ReadFile("../../configs/identity.json")
	if err != nil {
		t.Errorf("Error reading file: %v", err)
	}
	tcb, err := os.ReadFile("../../configs/tcb.json")
	if err != nil {
		t.Errorf("Error reading file: %v", err)
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := VerifyAttestation(tt.args.data, tt.args.identity, tt.args.tcb, tt.args.trusted)
