...
type Bootstrap struct {
	...
	Dacp     *Dacp     `protobuf:"bytes,7,opt,name=dacp,proto3" json:"dacp,omitempty"`
}
...
type Dacp struct {
	...
	IdentityPath string `protobuf:"bytes,1,opt,name=identity_path,json=identityPath,proto3" json:"identity_path,omitempty"`
	TcbPath      string `protobuf:"bytes,2,opt,name=tcb_path,json=tcbPath,proto3" json:"tcb_path,omitempty"`
	TrustedPath  string `protobuf:"bytes,3,opt,name=trusted_path,json=trustedPath,proto3" json:"trusted_path,omitempty"`
}
...
// Deprecated: Use Dacp.ProtoReflect.Descriptor instead.
func (*Dacp) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{6}
}

func (x *Dacp) GetIdentityPath() string {
	if x != nil {
...
func (x *Dacp) GetTrustedPath() string {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x06, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x12, 0x24, 0x0a, 0x04, 0x64, 0x61, 0x63, 0x70, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x44, 0x61, 0x63, 0x70, 0x52, 0x04, 0x64, 0x61, 0x63, 0x70, 0x22, 0xb8, 0x02,
	...
	0x66, 0x73, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x4f, 0x0a, 0x08, 0x43, 0x6f, 0x6e,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0xe6, 0x01, 0x0a, 0x06, 0x57,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x3c, 0x0a, 0x04, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x10, 0x02, 0x22, 0x69, 0x0a, 0x04, 0x44, 0x61, 0x63, 0x70, 0x12, 0x23, 0x0a, 0x0d, 0x69,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x50, 0x61, 0x74, 0x68,
	0x12, 0x19, 0x0a, 0x08, 0x74, 0x63, 0x62, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x74, 0x63, 0x62, 0x50, 0x61, 0x74, 0x68, 0x12, 0x21, 0x0a, 0x0c, 0x74,
	0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x50, 0x61, 0x74, 0x68, 0x2a, 0x51,
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 6: kratos.api.Bootstrap.dacp:type_name -> kratos.api.Dacp
	...
	1,  // 10: kratos.api.Wallet.mode:type_name -> kratos.api.Wallet.Mode
	...
	12, // 13: kratos.api.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
	12, // 14: kratos.api.Data.Database.conn_max_idle_time:type_name -> google.protobuf.Duration
